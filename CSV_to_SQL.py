...
for row in input_file:
    cursor.execute("insert into mineration_data (data_utc, ethperday, total_blocks, networkDifficulty, ethPrice_usd, ethPrice_BRL,"
                   "inflacao, indicador, "
                   "multiple_gpuPrice, R$_DollarPrice, Difficulty_LastDifficulty) \
                values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                   (row['Date(UTC)'], row['ETHPerDay'], row['TotalBlocks'] ,row['NetworkDifficulty[TH/s]'], row['ETHPriceUSD'],
